...
export const GET_ALL_EVENTS_REQUEST="GET_ALL_RESTAURANT_REQUEST";
export const GET_ALL_EVENTS_SUCCESS="GET_ALL_RESTAURANT_SUCCESS";
export const GET_ALL_EVENTS_FAILURE="GET_ALL_RESTAURANT_FAILURE";
...
export const CREATE_CATGORY_EVENTS_REQUEST="CREATE_CATGORY_EVENTS_REQUEST";
export const CREATE_CATGORY_EVENTS_SUCCESS="CREATE_CATGORY_EVENTS_SUCCESS";
export const CREATE_CATGORY_EVENTS_FAILURE="CREATE_CATGORY_EVENTS_FAILURE";

export const CREATE_CATEGORY_REQUEST="CREATE_CATEGORY_REQUEST";
export const CREATE_CATEGORY_SUCCESS="CREATE_CATEGORY_SUCCESS";
export const CREATE_CATEGORY_FAILURE="CREATE_CATEGORY_FAILURE";

export const GET_RESTAIRANTS_CATEGORY_REQUEST="GET_RESTAIRANTS_CATEGORY_REQUEST";
export const GET_RESTAIRANTS_CATEGORY_SUCCESS="GET_RESTAIRANTS_CATEGORY_SUCCESS";
export const GET_RESTAIRANTS_CATEGORY_FAILURE="GET_RESTAIRANTS_CATEGORY_FAILURE";